// Title : http://www.omdbapi.com/?apikey=3eebb3b3=avatar
// Search-result : https://www.omdbapi.com/?apikey=3eebb3b3=avatar&page=1
...
async function loadMovies(title) {
  const URL = `http://www.omdbapi.com/?i=tt3896198&apikey=3eebb3b3=${title}&page=1`;
  ...
  searchListMovies.forEach((movie) => {
    movie.addEventListener("click", async () => {
      ...
      const result = await fetch(
        `https://www.omdbapi.com/?i=${movie.dataset.id}&apikey=3eebb3b3`
      );
